...
export async function POST(req: Request) {
  try {
    ...
    const allowed: ImageSize[] = ["1024x1024", "1024x1536", "1536x1024", "auto"];
    const sizeOpt: ImageSize = (allowed as readonly string[]).includes(size) ? (size as ImageSize) : "1024x1024";
    ...
    return new Response(JSON.stringify({ images, usedPrompt: fullPrompt }), {
